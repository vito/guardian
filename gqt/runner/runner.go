...
func Start(bin string, iodaemonBin string, argv ...string) *RunningGarden {
	...
	c := cmd(tmpDir, depotDir, iodaemonBin, graphPath, network, addr, bin, RootFSPath, argv...)
...
func cmd(tmpdir, depotDir, iodaemonBin, graphPath, network, addr, bin, RootFSPath string, argv ...string) *exec.Cmd {
